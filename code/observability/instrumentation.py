    ...
    def export(self, spans) -> SpanExportResult:
        ...
        try:
            ...
            if running_loop is not None:
                ...
                logger.debug("Scheduled %d trace(s) for async persistence", len(trace_contexts))
            else:
                ...
                try:
                    ...
                    logger.info("Persisted %d trace(s) synchronously", len(trace_contexts))
            ...
            logger.error("Error exporting spans to database: %s", e, exc_info=True)
            return SpanExportResult.FAILURE
            ...
            for trace_context in trace_contexts:
                try:
                    ...
                    logger.error(
                        ...
                        trace_context.agent_execution_id, e, exc_info=True,
                    )
        finally:
