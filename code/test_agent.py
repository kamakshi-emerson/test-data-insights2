...
from agent import DataInsightsAssistantForNonTechnicalUsersAgent

class TestDataInsightsAssistantForNonTechnicalUsersAgent:
    
    @pytest.fixture
    def agent(self):
        return DataInsightsAssistantForNonTechnicalUsersAgent()
